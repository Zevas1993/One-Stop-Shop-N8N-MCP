...
export class PatternAgent extends BaseAgent {
  ...
  async initialize(): Promise<void> {
    ...
    this.logger.info('Pattern agent initialized with ' + this.patterns.size + ' patterns');
  }
  ...
  async execute(input: AgentInput): Promise<AgentOutput> {
    ...
    try {
      ...
      return {
        ...
        executionTime: Date.now() - startTime,
        tokensUsed: Math.min(keywords.length * 100 + matches.length * 500, this.config.contextBudget),
      };
    } catch (error) {
  ...
  private loadPatterns(): void {
    const patterns: WorkflowPattern[] = [
      ...
      },
      {
        ...
        keywords: ['database', 'sql', 'create', 'read', 'update', 'delete', 'crud'],
        nodes: ['n8n-nodes-base.mysql', 'n8n-nodes-base.postgres', 'n8n-nodes-base.set'],
        complexity: 'medium',
      },
      {
        id: 'conditional-flow',
        ...
        nodes: ['n8n-nodes-base.if', 'n8n-nodes-base.switch', 'n8n-nodes-base.split'],
        complexity: 'medium',
      },
      {
        id: 'error-handling',
        ...
        nodes: ['n8n-nodes-base.errorHandler', 'n8n-nodes-base.set', 'n8n-nodes-base.if'],
        complexity: 'medium',
      },
      {
        id: 'scheduling',
      ...
      },
      {
        ...
        nodes: ['n8n-nodes-base.fileCreate', 'n8n-nodes-base.googleDrive', 's3'],
        complexity: 'medium',
      },
      {
        ...
        nodes: ['n8n-nodes-base.set', 'n8n-nodes-base.httpRequest', 'n8n-nodes-base.switch'],
        complexity: 'complex',
      },
    ];
